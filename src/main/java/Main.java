...
//        String html = "<P style=\"margin-left:1.0pt;\"><font style='font-size:11pt;'>다음 글을 읽고 사건의 흐름을 정리하였을 때, 빈칸에 들어갈 사건으로 적절한 것에 ○표, 적절하지 않은 것에 X표 하시오.</font></P>";
...
//		HWPWriter.toFile(hwpFile, writePath);
        ...
        HWPFile hwpFile_blank = HWPReader.fromFile("C:/Users/Gyu/Downloads/테스트용 한글파일/실전 테스트/blank.hwp");
        HWPFile hwpFile_real = HWPReader.fromFile("C:/Users/Gyu/Downloads/테스트용 한글파일/새 한컴오피스 한글 2010 문서.hwp");
        hwpFile_blank.getBodyText().getSectionList().get(0).getParagraph(0).getText()
